...
11	1	Endor	Fuvi	Gribi Nabo	45	123	Hremish	TUR
13	1	Maria	Musel	Rattaat	46	12345	Habich	BEN
...
SELECT pg_catalog.setval('public.user_stored_addresses_id_seq', 33, true);
...
SELECT pg_catalog.setval('public.user_stored_music_id_seq', 2, true);
