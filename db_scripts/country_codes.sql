DROP TABLE IF EXISTS public.continent_codes;
...
INSERT INTO public.continent_codes VALUES
                             ('AF', 'Africa'),
                             ('AS', 'Asia'),
                             ('EU', 'Europe'),
                             ('NA', 'North America'),
...
CREATE TABLE public.country_codes (
                             ...
                             PRIMARY KEY (code),
                             CONSTRAINT fk_countries_continents FOREIGN KEY (continent_code) REFERENCES continent_codes (code)
);

CREATE INDEX continent_code ON public.country_codes (continent_code);

INSERT INTO public.country_codes (code, continent_code, name, iso3, number, full_name) VALUES
...
ALTER TABLE country_codes ADD CONSTRAINT iso3_unique UNIQUE (iso3);